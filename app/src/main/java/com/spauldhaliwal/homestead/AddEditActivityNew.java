...
public class AddEditActivityNew extends BaseActivity {
...
//        loadToolbar();
                ...
                switch (mMode) {
                    case ADD:
                        ...
                        if (FirebaseResolver.insertJob(name,
                            ...
                            Toast.makeText(AddEditActivityNew.this, "Name is required.", Toast.LENGTH_LONG).show();
                        }
                        break;
        ...
        addNoteButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                addNoteDialog = new Dialog(AddEditActivityNew.this);
